...
class MiniAudioPlayer extends HTMLElement {
  ...
  render() {
    this.shadowRoot.innerHTML = `
      ...
      <style>
        /* Add styles specific to mini player */
      </style>
    `;
  }
  ...
  setupEventListeners() {
    ...
    const audio = shadow.querySelector(`audio[data-player="${this.playerIndex}"]`);
    const icon = playPauseButton.querySelector(`img[data-player="${this.playerIndex}"]`);
    const currentTimeElem = shadow.querySelector(`.currentTime[data-player="${this.playerIndex}"]`);
    const totalTimeElem = shadow.querySelector(`.totalTime[data-player="${this.playerIndex}"]`);
    const progressBar = shadow.querySelector(`input.progress[data-player="${this.playerIndex}"]`);
